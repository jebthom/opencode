...
// Emitted when a cached code-graph scope goes stale because a file inside its
...
// module from the codegraph route group guarantees registration happens before
...
export * as CodeGraphEvent from "./event"
